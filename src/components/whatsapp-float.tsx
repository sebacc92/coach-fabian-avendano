...
export const WhatsappFloat = component$(() => {
  return (
    <a
      ...
      class="fixed z-50 bottom-6 left-6 bg-[#25D366] text-white rounded-full shadow-lg p-3 flex items-center justify-center transition-transform duration-200 hover:scale-110 hover:bg-[#1ebe57] focus:outline-none focus:ring-2 focus:ring-[#25D366]"
    >
