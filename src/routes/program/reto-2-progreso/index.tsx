...
export default component$(() => {
  ...
  const program = {
    ...
    alt: "Fabián Avendaño haciendo handstand - Reto 2 Progreso",
    price: "35.000 ARS",
    ...
    subtitle: "Lleva tu entrenamiento al siguiente nivel",
    desc: "Un programa diseñado para quienes ya tienen una base y buscan desafiar sus límites. Aumenta la intensidad, mejora tu técnica y consolida tus hábitos.",
    featuresLabel: "Incluye:",
    features: "Rutinas avanzadas, técnicas de progresión y mayor volumen de entrenamiento.",
    cta: "¡ACEPTO EL DESAFÍO!",
    link: "/contacto",
    duration: "28 días",
      ...
      <section class="py-16 md:py-24 bg-gray-800">
        <div class="container mx-auto px-4 text-center">
          ...
          <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            No te conformes. Sigue avanzando y descubre tu verdadero potencial.
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <div class={`${program.priceColor} text-white px-8 py-4 rounded-full text-2xl font-bold`}>
              {program.price}
